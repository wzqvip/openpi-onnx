...
OUTPUT_PATH = "./checkpoints/pi05_libero_pytorch/model.nvfp4.onnx"
...
def main():
    ...
    # Tiny model patching is DISABLED by not monkey-patching _gemma_mod.get_config
    print("Tiny model patch DISABLED.")
    
    # Patch sample_time to return export_dtype
    ...
    def sample_time_patched(self, bsize, device):
        ...
        # We need to decide dtype effectively. We can check model dtype or just check device here.
        # Since we modified main locals, we can't easily access export_dtype var inside this closure 
        # unless we pass it or verify from device.
    ...
    # --- Quantization Setup (NVFP4) ---
    print("Quantizing logic (NVFP4)...")
    ...
    print(f"Exporting NVFP4 model to {OUTPUT_PATH}...")
    ...
    onnx.save_model(
        ...
        location="model.nvfp4.onnx.data", 
        size_threshold=1024, 
