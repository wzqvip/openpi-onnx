...
# Define paths
CHECKPOINT_DIR = "/home/taco/openpi-onnx/checkpoints/pi05_libero_pytorch"
CONFIG_NAME = "pi05_libero"
FP16_MODEL = "/home/taco/openpi-onnx/dist/final_fp16/model.fp32.onnx"
W8A16_MODEL = "/home/taco/openpi-onnx/dist/final_w8a16/model.w8a16.onnx"
...
def main():
    ...
    print(f"[PyTorch] Loading policy from: {CHECKPOINT_DIR}")
    ...
    # Patch sample time for deterministic flow if needed (export script did this)
    # But for verification, we use sample_actions which calls the full stack.
    # We rely on noise being passed in.
    ...
    def verify_onnx(model_path, model_name):
        ...
        # Map torch inputs to whatever the ONNX model expects
        # We assume the order or suffix matches enough to disambiguate, or we map explicitly
        # Known mappings:
        mapping = {
    ...
    # Verify FP16 (Baseline export)
    verify_onnx(FP16_MODEL, "FP16 (W16A16)")

    # Verify W8A16
    verify_onnx(W8A16_MODEL, "W8A16 (QDQ)")
