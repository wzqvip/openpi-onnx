...
OUTPUT_PATH = "./checkpoints/pi05_libero_pytorch/model.nvfp8.onnx"
...
def main():
    ...
    def sample_time_patched(self, bsize, device):
        ...
        # Use Float32 logic matching the force below
    ...
    # --- Quantization Setup (NVFP8) ---
    print("Quantizing logic (NVFP8)...")
    ...
    print(f"Exporting NVFP8 model to {OUTPUT_PATH}...")
    ...
    onnx.save_model(
        ...
        location="model.nvfp8.onnx.data", 
        size_threshold=1024, 
